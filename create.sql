CREATE TABLE ASSIGNMENT (ID INTEGER AUTO_INCREMENT NOT NULL, ASSIGNEDON DATETIME, DESCRIPTION VARCHAR(255), DUEON DATETIME, TITLE VARCHAR(255), COURSE_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE h_user (ID INTEGER AUTO_INCREMENT NOT NULL, EMAIL VARCHAR(255), FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), PASSWORD VARCHAR(255), STATUS VARCHAR(255), PRIMARY KEY (ID))
