...
CREATE TABLE CAUSUALRELATION (ID INTEGER AUTO_INCREMENT NOT NULL, ACHIEVEMENTCAUSE_ID INTEGER, ACHIEVEMENTRESULT_ID INTEGER, TASKCAUSE_ID INTEGER, TASKRESULT_ID INTEGER, PRIMARY KEY (ID))
