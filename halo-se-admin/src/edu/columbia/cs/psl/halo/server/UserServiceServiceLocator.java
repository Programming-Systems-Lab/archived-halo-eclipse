...
public class UserServiceServiceLocator extends org.apache.axis.client.Service implements edu.columbia.cs.psl.halo.server.UserServiceService {
    ...
    private java.lang.String UserServicePort_address = "http://pazuzu.local:8080/UserServiceService/UserService";
    ...
    public edu.columbia.cs.psl.halo.server.UserService getUserServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            edu.columbia.cs.psl.halo.server.UserServicePortBindingStub _stub = new edu.columbia.cs.psl.halo.server.UserServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (edu.columbia.cs.psl.halo.server.UserService.class.isAssignableFrom(serviceEndpointInterface)) {
                edu.columbia.cs.psl.halo.server.UserServicePortBindingStub _stub = new edu.columbia.cs.psl.halo.server.UserServicePortBindingStub(new java.net.URL(UserServicePort_address), this);
                _stub.setPortName(getUserServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://server.halo.psl.cs.columbia.edu/", "UserServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://server.halo.psl.cs.columbia.edu/", "UserServicePort"));
        }
